...
const c5_jpg_1 = __importDefault(require("../public/assets/c5.jpg"));
const react_1 = require("react");
const SignupModal_1 = __importDefault(require("./SignupModal"));
function Home() {
          ...
          <div className="container mx-auto px-6 flex justify-between items-center">
            ...
            <nav>
              <ul className="flex space-x-4">
                <li>
                  <a href="#features" className="text-blue-800 hover:text-blue-600">
                    Features
                  </a>
                </li>
                <li>
                  <a href="#about" className="text-blue-800 hover:text-blue-600">
                    About
                  </a>
                </li>
                <li>
                  <a href="#reviews" className="text-blue-800 hover:text-blue-600">
                    Reviews
                  </a>
                </li>
                <li>
                  <a href="#contact" className="text-blue-800 hover:text-blue-600">
                    Contact
                  </a>
                </li>
              </ul>
        ...
        <main className="flex-grow">
          <section className="container mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
            <div className="text-blue-800">
              ...
              <button onClick={handleOpenModal} className="mt-6 inline-block bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600">
                Register Now
              </button>

              <SignupModal_1.default isOpen={isModalOpen} onClose={handleCloseModal}/>
            ...
            <div className="flex justify-center">
              <image_1.default src={c5_jpg_1.default} alt="Course" className="rounded-lg shadow-md"/>
            </div>
          </section>
          ...
          <section id="contact" className="bg-blue-50 py-12">
            <div className="container mx-auto px-6 text-center text-blue-800">
              ...
              <a href="mailto:info@course.com" className="mt-6 inline-block bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600">
                Email Us
              </a>
            </div>
          </section>
